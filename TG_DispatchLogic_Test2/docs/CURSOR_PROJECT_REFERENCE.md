...
| **撚紗下料派 Cake** | ✅ 已實作 | 請下料 → 空車 CAKE-13~24 取無絲 Cake（3 停 × 4） |
| **撚紗下料派 Bobbin** | ✅ 已實作 | 請下料 → 空車 BOBBIN-01~08 取有絲 Bobbin（6 停 × 4；殘餘跨側第 7 趟） |
| **清軸上料派 Cake** | ✅ 已實作 | 無絲 Cake 車 → 清軸站 |
| **AOI 上料派 Bobbin** | ✅ 已實作 | 滿載 Bobbin → PKP001/002（忽略 Modbus；兩站可同時） |
...
| 日期 | 變更 |
|------|------|
| 2026-07 | AOI 上料 Bobbin：PKP001/002、24 Port 有絲、actionid=2、`bobbin_mission` |
| 2026-07 | 撚紗下料 Bobbin：6 停滿車、跨側殘餘第 7 趟、BOBBIN-01~08、`bobbin_mission` |
